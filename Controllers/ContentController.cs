...
namespace AssetWebManager.Controllers
{
    public class ContentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Version,Region")] ContentLockModel contentLockModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Version,Region")] ContentLockModel contentLockModel)
        {
